...
The aim of http-vue-loader is to quickly test .vue components without any compilation step, however, for production, I recomand to use [webpack module bundler](https://webpack.github.io/docs/) with [vue-loader](https://github.com/vuejs/vue-loader), see also [why Vue.js doesn't support templateURL)(https://vuejs.org/2015/10/28/why-no-template-url/).
